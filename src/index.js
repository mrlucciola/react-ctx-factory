...
var createCtxHook = (Ctx) => (selector) => {
...
var useCtxFactory = (useCtxHook, label) => {
  const Ctx = import_react.createContext(null);
  Ctx.displayName = label + "Ctx";
  const Provider = ({ children }) => /* @__PURE__ */ jsx_dev_runtime.jsxDEV(Ctx.Provider, {
    value: useCtxHook(),
    children
